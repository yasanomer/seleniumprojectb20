...
//        e. “Retrieve password” button
        ...
        WebElement retrieve = driver.findElement(By.cssSelector("button.radius"));
...
//        4. Verify all WebElements are displayed.
        ...
        if(homeLink.isDisplayed() && header.isDisplayed() && emailLabel.isDisplayed() && emailInput.isDisplayed()
        && linkText.isDisplayed() && poweredByDiv.isDisplayed()){
